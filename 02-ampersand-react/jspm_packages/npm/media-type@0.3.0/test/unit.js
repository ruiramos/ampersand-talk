...
["application/atom+xml", "application/cals-1840", "application/mac-binhex40", "application/mikey", "application/rpki-ghostbusters", "application/sparql-query", "application/sparql-results+xml", "application/vnd.3M.Post-it-Notes", "application/vnd.nintendo.snes.rom", "application/vnd.nokia.iSDS-radio-presets", "application/vnd.openxmlformats-officedocument.spreadsheetml.pivotTable+xml", "application/vnd.openxmlformats-officedocument.wordprocessingml.document.glossary+xml;k2=\"v2a;v2b\";k1=v1", "application/vnd.Quark.QuarkXPress", "application/vnd.software602.filler.form-xml-zip", "application/vnd.wrq-hp3000-labelled", "application/x-test", "application/yin+xml", "application/yang", "audio/amr-wb+", "audio/ip-mr_v2.5", "audio/mpeg", "audio/t140c", "audio/x-test", "image/g3fax", "image/png", "image/svg+xml;charset=utf8", "image/t38", "image/x-test", "message/delivery-status", "message/s-http", "message/x-test", "model/x-test", "model/x3d+xml", "multipart/form-data", "multipart/voice-message", "multipart/x-test", "text/javascript", "text/prs.lines.tag", "text/RED", "text/vnd.DMClientScript; charset=iso-8859-1", "text/vnd.sun.j2me.app-descriptor", "text/x-test", "video/CelB", "video/H264", "video/vnd.CCTV", "video/vnd.iptvforum.2dparityfec-2005", "video/x-test", "text/xml; subtype=gml/3.1.1", "application/LD+JSON-SQL*CSV.1", "*/*", "audio/*"].forEach(function(value) {
  var type = mediaType.fromString(value);
  assert.ok(type.isValid(), "Valid media type " + value + " was invalid");
});
["", " ", null, "null", "/", "text/;plain", 'text/"plain"', "text/p£ain", "text/(plain)", "text/@plain", "text/plain,wrong", "*", "*/plain", "fonts/package", "chemical/x-cif", "virtual/bluedevil-audio", "example/test", "application/example", "audio/example", "image/example", "message/example", "model/example", "multipart/example", "text/example", "video/example"].forEach(function(value) {
  var type = mediaType.fromString(value);
