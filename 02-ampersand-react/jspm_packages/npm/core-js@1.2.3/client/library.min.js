...
(function(process) {
  !function(b, c, a) {
    ...
    !function(b) {
      ...
      var e = b(2),
          ...
          T = function stringify(f) {
            for (var a,
                b,
                c = [f],
                d = 1,
                e = arguments; e.length > d; )
              c.push(e[d++]);
      ...
      var c = b(12),
          e = b(94),
          d = "includes";
      c(c.P + c.F * b(96)(d), "String", {includes: function includes(b) {
      ...
      var c = b(12),
          ...
          d = "startsWith",
          e = ""[d];
      c(c.P + c.F * b(96)(d), "String", {startsWith: function startsWith(i) {
          var b = g(this, i, d),
              j = arguments,
      ...
      var o,
          ...
          f = function() {
            function P2(b) {
              var a = new c(b);
              return v(a, P2.prototype), a;
            }
            var a = !1;
            try {
              if (a = c && c.resolve && u(), v(P2, c), P2.prototype = k.create(c.prototype, {constructor: {value: P2}}), P2.resolve(5).then(function() {}) instanceof P2 || (a = !1), a && b(3)) {
                var d = !1;
          ...
          D = function(a) {
            return p(a) && (f ? "Promise" == y(a) : j in a);
          },
          E = function(a, b) {
            return H && a === c && b === o ? !0 : G(a, b);
          },
          w = function(b) {
            var c = F(b)[C];
            return c != a ? c : b;
              ...
              q(function() {
                for (var e = b.v,
                    ...
                    i = function(a) {
                      var c,
                          ...
                          d = f ? a.ok : a.fail;
                      try {
                        d ? (f || (b.h = !0), c = d === !0 ? e : d(e), c === a.P ? a.rej(TypeError("Promise-chain cycle")) : (g = x(c)) ? g.call(c, a.res, a.rej) : a.res(c)) : a.rej(e);
                      } catch (h) {
                        a.rej(h);
                      }
                    }; c.length > g; )
                ...
                c.length = 0, b.n = !1, d && setTimeout(function() {
                  var f,
                      c,
                      d = b.p;
                  z(d) && (I ? s.emit("unhandledRejection", e, d) : (f = h.onunhandledrejection) ? f({
                    promise: d,
                    reason: e
        ...
        then: function then(d, e) {
          var a = {
            ...
            fail: "function" == typeof e ? e : !1
              ...
              f = a.P = new (B(this, c))(function(b, c) {
                a.res = b, a.rej = c;
              });
          m(a.res), m(a.rej);
          var b = this[j];
          return b.c.push(a), b.a && b.a.push(a), b.s && l(b, !1), f;
        },
        "catch": function(b) {
          return this.then(a, b);
        }
      })), d(d.G + d.W + d.F * !f, {Promise: c}), b(34)(c, e), n(c), n(o = b(13)[e]), d(d.S + d.F * !f, e, {reject: function reject(a) {
          return new this(function(c, b) {
            b(a);
          });
        }}), d(d.S + d.F * (!f || u(!0)), e, {resolve: function resolve(a) {
          return D(a) && E(a.constructor, this) ? a : new this(function(b) {
            b(a);
          });
      ...
      e.exports = function(i, m, r, o, j, k) {
        ...
        return b(3) && "function" == typeof e && (k || l.forEach && !b(4)(function() {
          ...
          a in l && (!k || "clear" != a) && f(e.prototype, a, function(c, d) {
            ...
            return this._c.size;
          }})) : (e = o.getConstructor(m, i, j, p), b(129)(e.prototype, r)), b(34)(e, i), q[i] = e, c(c.G + c.W + c.F, q), k || o.setStrong(e, i, j), e;
      };
    }, function(d, e, b) {
      var c = b(131);
      b(132)("Set", function(b) {
        return function Set() {
          return b(this, arguments.length > 0 ? arguments[0] : a);
        };
      }, {add: function add(a) {
      ...
      7 != (new e).set((Object.freeze || Object)(f), 7).get(f) && k.each.call(["delete", "has", "get", "set"], function(a) {
        var c = e.prototype,
            f = c[a];
        b(32)(c, a, function(b, c) {
          if (d(b) && !i(b)) {
            var e = g(this)[a](b, c);
            return "set" == a ? this : e;
          }
          return f.call(this, b, c);
        });
      });
    }, function(k, s, b) {
      var q = b(33),
 ...
 while (!d(e, c = f[b._i++]));
      ...
      var c = a(172),
          b = a(12);
      a(13)._ = c._ = c._ || {}, b(b.P + b.F, "Function", {part: a(171)});
    }, function(c, d, b) {
      var a = b(12);
