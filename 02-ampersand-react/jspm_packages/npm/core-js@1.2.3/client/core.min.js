...
(function(process) {
  !function(b, c, a) {
    ...
    !function(b) {
      ...
      var c = b(12),
          e = b(98),
          d = "includes";
      c(c.P + c.F * b(100)(d), "String", {includes: function includes(b) {
      ...
      var c = b(12),
          ...
          d = "startsWith",
          e = ""[d];
      c(c.P + c.F * b(100)(d), "String", {startsWith: function startsWith(i) {
          var b = g(this, i, d),
              j = arguments,
      ...
      d.exports = function(i, r, u, q, k, j) {
        ...
        if ("function" == typeof d && (j || h.forEach && !b(4)(function() {
          ...
          d = q.getConstructor(r, i, k, l), b(140)(d.prototype, u);
        return b(34)(d, i), s[i] = d, c(c.G + c.W + c.F * (d != n), s), j || q.setStrong(d, i, k), d;
      };
    }, function(d, e, b) {
      var c = b(142);
      b(143)("Set", function(b) {
        return function Set() {
          return b(this, arguments.length > 0 ? arguments[0] : a);
        };
      }, {add: function add(a) {
 ...
 while (!d(e, c = f[b._i++]));
      ...
      var c = a(183),
          b = a(12);
      a(13)._ = c._ = c._ || {}, b(b.P + b.F, "Function", {part: a(182)});
    }, function(c, d, b) {
      var a = b(12);
