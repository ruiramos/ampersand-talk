...
module.exports = function(file) {
  ...
  var codeString = ';' + ['if (typeof window !== "undefined") {', '  window.ampersand = window.ampersand || {};', '  window.ampersand["' + name + '"] = window.ampersand["' + name + '"] || [];', '  window.ampersand["' + name + '"].push("' + version + '");', '}'].join('');
