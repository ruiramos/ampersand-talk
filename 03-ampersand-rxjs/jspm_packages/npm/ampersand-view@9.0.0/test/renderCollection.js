...
var Collection = AmpersandCollection.extend({model: Model});
...
function getModelData() {
  return ['Henrik Joreteg', 'Bugs Bunny', 'Scrooge McDuck', 'Crazy Dave', 'Arty Cee'].map(function(name, count) {
    return {
      id: ++count,
...
test('filtered', function(t) {
  var view = new MainView();
  view.render({filter: function(model) {
